...
def seed_pattern_definitions() -> list[dict[str, object]]:
    return [
        _pattern("ETF_INFLOW_SHOCK", "ETF inflow shock", "Spot Bitcoin ETF inflow surprise or acceleration.", "POSITIVE", ["15m", "1h", "4h"], "Strong"),
        ...
        _pattern("INSTITUTIONAL_ACCUMULATION", "Institutional accumulation", "Institutional Bitcoin accumulation, custody, or allocation narrative.", "POSITIVE", ["1h", "4h", "24h"], "Strong"),
        _pattern("MACRO_RISK_ON", "Macro risk-on", "Broad risk-on macro conditions supportive for BTC.", "POSITIVE", ["1h", "4h", "24h"], "Moderate"),
        _pattern("MACRO_RISK_OFF", "Macro risk-off", "Broad risk-off macro conditions pressuring BTC.", "NEGATIVE", ["1h", "4h", "24h"], "Moderate"),
        _pattern("BANKING_STRESS", "Banking stress", "Banking-system stress or fiat-liquidity confidence shock.", "POSITIVE", ["1h", "4h", "24h"], "Moderate"),
        _pattern("SECURITY_EXPLOIT", "Security exploit", "Exploit, protocol issue, or ecosystem-security disclosure.", "NEGATIVE", ["15m", "1h", "4h"], "Strong", "elevated", 1.05),
        _pattern("SECURITY_INCIDENT", "Security incident", "Security incident, exploit, malware, or ecosystem risk disclosure.", "NEGATIVE", ["15m", "1h", "4h"], "Strong"),
        _pattern("VOLATILITY_EXPANSION", "Volatility expansion", "Volatility breakout or market-structure expansion narrative.", "NEUTRAL", ["15m", "1h", "4h"], "Moderate"),
    ]
...
def _pattern(
    ...
    return {
        ...
        "expected_reaction_window": expected_time_windows[0] if expected_time_windows else "unknown",
