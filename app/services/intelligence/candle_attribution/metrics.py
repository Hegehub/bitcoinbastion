...
CANDLE_CANDIDATES_GENERATED_TOTAL = Counter(
    "candle_candidates_generated_total", "Total raw candidate events generated for candle attribution."
)
CANDLE_ATTRIBUTION_CONFIDENCE_DISTRIBUTION = Histogram(
    "candle_attribution_confidence_distribution", "Distribution of final candle attribution confidence scores."
)
...
ATTRIBUTION_CONFIDENCE_DISTRIBUTION = Histogram(
    "attribution_confidence_distribution", "Distribution of candle attribution ranking confidence scores."
)
