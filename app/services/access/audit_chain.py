...
class AccessAuditEventType(StrEnum):
    ...
    TRANSPARENCY_CHECKPOINT_DRAFT_CREATED = "transparency_checkpoint_draft_created"
    TRANSPARENCY_CHECKPOINT_BUILT = "transparency_checkpoint_built"
    TRANSPARENCY_CHECKPOINT_SIGNED = "transparency_checkpoint_signed"
    TRANSPARENCY_CHECKPOINT_SIGNATURE_FAILED = "transparency_checkpoint_signature_failed"
    TRANSPARENCY_CHECKPOINT_VERIFIED = "transparency_checkpoint_verified"
    TRANSPARENCY_CHECKPOINT_VERIFICATION_FAILED = "transparency_checkpoint_verification_failed"
    TRANSPARENCY_CHECKPOINT_PUBLISHED = "transparency_checkpoint_published"
    TRANSPARENCY_CHECKPOINT_PUBLICATION_FAILED = "transparency_checkpoint_publication_failed"
    TRANSPARENCY_CHECKPOINT_SUPERSEDED = "transparency_checkpoint_superseded"
    TRANSPARENCY_CHECKPOINT_CHAIN_GAP_DETECTED = "transparency_checkpoint_chain_gap_detected"
