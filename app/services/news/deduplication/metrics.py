...
NEWS_CLUSTER_REASSIGNMENTS_TOTAL = Counter(
    "news_cluster_reassignments_total", "Cluster reassignments"
)
NEWS_SIMILARITY_CALCULATIONS_TOTAL = Counter(
    "news_similarity_calculations_total", "Similarity calculations"
)
