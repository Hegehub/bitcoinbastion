...
def decide(trace_band: str, confidence: float, amount_sensitivity: AmountSensitivity, disagreement: str) -> SafeToSendAdvisory:
    ...
    if disagreement in {"MEDIUM", "HIGH"} or confidence < 0.35 or amount_sensitivity in {AmountSensitivity.HIGH, AmountSensitivity.VERY_HIGH}:
