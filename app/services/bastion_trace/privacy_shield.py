...
class PrivacyShieldService:
    def build_privacy_shield(self, address: str, utxos: list[int] | None = None, reuse_count: int | None = None) -> PrivacyShieldReport:
        ...
        if utxos is None:
            return PrivacyShieldReport(address=address, chain="bitcoin", privacy_exposure_score=0.0, privacy_band=PrivacyBand.UNKNOWN, utxo_hygiene=hygiene, dust_radar=dust, address_reuse=reuse, consolidation_risk=consolidation, toxic_change=toxic, privacy_reason_codes=["PRIVACY_SHIELD_CREATED", "PRIVACY_DATA_SOURCE_LIMITED", "PRIVACY_NOT_ILLICIT_RISK"], privacy_limitations=["utxo_data_unavailable"], privacy_guidance=build_privacy_guidance(), evidence_refs=[], confidence=0.2, freshness="UNKNOWN", advisory_not_legal_verdict=True, not_consensus_proof=True, no_custody=True, created_at=datetime.now(UTC))
        score = 0.0
        ...
        return PrivacyShieldReport(address=address, chain="bitcoin", privacy_exposure_score=score, privacy_band=band, utxo_hygiene=hygiene, dust_radar=dust, address_reuse=reuse, consolidation_risk=consolidation, toxic_change=toxic, privacy_reason_codes=["PRIVACY_SHIELD_CREATED", "PRIVACY_NOT_ILLICIT_RISK"], privacy_limitations=[], privacy_guidance=build_privacy_guidance(), evidence_refs=[], confidence=0.4, freshness="UNKNOWN", advisory_not_legal_verdict=True, not_consensus_proof=True, no_custody=True, created_at=datetime.now(UTC))
