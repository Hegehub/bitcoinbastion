...
TRACE_REQUESTS = Counter("bastion_trace_requests_total", "Trace requests", ["tier", "operation", "status"])
...
TRACE_WATCH_ALERT = Counter("bastion_trace_watchtower_alerts_total", "Watchtower alerts", ["severity"])
TRACE_DISAGREE = Counter("bastion_trace_provider_disagreement_total", "Provider disagreement", ["severity"])
TRACE_SOURCE_REFRESH = Counter("bastion_trace_source_refresh_total", "Source refresh", ["source_type", "status"])
TRACE_SOURCE_REFRESH_FAIL = Counter("bastion_trace_source_refresh_failures_total", "Source refresh failures", ["source_type"])
TRACE_CONF = Gauge("bastion_trace_confidence", "Trace confidence", ["tier"])
TRACE_EVIDENCE_INDEP = Gauge("bastion_trace_evidence_independence", "Evidence independence", ["tier"])
...
TRACE_RUNTIME = Counter("bastion_trace_runtime_events_total", "Runtime events", ["event_type", "severity", "status"])
