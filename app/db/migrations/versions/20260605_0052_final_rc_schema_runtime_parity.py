...
def upgrade() -> None:
    op.add_column(
        ...
        sa.Column(
            ...
            sa.String(length=32),
            nullable=False,
            server_default="median_multi_provider",
        ),
    )
    op.add_column(
        "btc_candles",
        sa.Column("provider_disagreement_score", sa.Float(), nullable=False, server_default="0"),
    )
    op.add_column(
        "btc_candles",
        sa.Column(
            ...
            sa.String(length=32),
            nullable=False,
            server_default="hierarchical_v1",
        ),
    )
    op.add_column(
        "btc_candles",
    ...
    op.add_column(
        "btc_candles",
        sa.Column("market_regime", sa.String(length=16), nullable=False, server_default="normal"),
    )
    op.add_column(
        "btc_candles", sa.Column("volatility_score", sa.Float(), nullable=False, server_default="0")
    )
    op.add_column(
        "btc_candles",
        sa.Column("evidence_packet_id", sa.String(length=64), nullable=False, server_default=""),
    )
    ...
    op.create_index(
        "ix_btc_price_points_aggregation_round_id", "btc_price_points", ["aggregation_round_id"]
    )
    op.create_index(
        "ix_btc_price_points_raw_payload_hash", "btc_price_points", ["raw_payload_hash"]
    )

    with op.batch_alter_table("news_articles") as batch_op:
        batch_op.add_column(
            sa.Column("uuid", sa.String(length=36), nullable=False, server_default="")
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column("url_hash", sa.String(length=64), nullable=False, server_default="")
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column("article_type", sa.String(length=64), nullable=False, server_default="NEWS")
        )
        batch_op.add_column(
        ...
        batch_op.add_column(
            sa.Column(
                "sentiment_label", sa.String(length=32), nullable=False, server_default="UNKNOWN"
            )
        )
        batch_op.add_column(
        ...
        batch_op.alter_column(
            "metadata_json", existing_type=sa.Text(), type_=sa.JSON(), nullable=False
        )
    op.execute("UPDATE news_articles SET uuid = 'legacy-article-' || id WHERE uuid = ''")
    op.execute(
        "UPDATE news_articles SET normalized_title = lower(title) WHERE normalized_title = ''"
    )
    ...
    op.execute(
        "UPDATE news_articles SET canonical_url_hash = 'legacy-canonical-url-' || id WHERE canonical_url_hash = ''"
    )
    ...
    op.create_index(
        "ix_news_articles_btc_relevance_score", "news_articles", ["btc_relevance_score"]
    )
    ...
    op.add_column(
        "news_sources", sa.Column("uuid", sa.String(length=36), nullable=False, server_default="")
    )
    op.add_column("news_sources", sa.Column("slug", sa.String(length=120), nullable=True))
    op.add_column(
        "news_sources",
        sa.Column("tier", sa.String(length=80), nullable=False, server_default="market_media"),
    )
    op.add_column(
        "news_sources",
        sa.Column("supports_etag", sa.Boolean(), nullable=False, server_default=sa.false()),
    )
    op.add_column(
        "news_sources",
        sa.Column(
            "supports_last_modified", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
    )
    op.add_column(
        "news_sources",
    ...
    op.add_column(
        "news_sources", sa.Column("metadata_json", sa.JSON(), nullable=False, server_default="{}")
    )
    ...
    op.add_column(
        ...
        sa.Column("duplication_rate", sa.Float(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
    ...
    op.add_column(
        "source_reputation_profiles",
        sa.Column("first_mover_score", sa.Float(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
    ...
    op.add_column(
        "source_reputation_profiles",
        sa.Column("market_relevance_score", sa.Float(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
        sa.Column("security_relevance_score", sa.Float(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
        sa.Column("macro_relevance_score", sa.Float(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
        sa.Column("bitcoin_native_score", sa.Float(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
        sa.Column("total_articles_seen", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
        sa.Column("total_events_created", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "source_reputation_profiles",
    ...
    op.create_index(
        "ix_source_reputation_profiles_reliability_score",
        "source_reputation_profiles",
        ["reliability_score"],
    )
    op.create_index(
        "ix_source_reputation_profiles_signal_quality_score",
        "source_reputation_profiles",
    ...
    op.create_index(
        "ix_intelligence_timeline_events_event_time", "intelligence_timeline_events", ["event_time"]
    )
    op.create_index(
        "ix_intelligence_timeline_events_event_type", "intelligence_timeline_events", ["event_type"]
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_source_reputation_profiles_signal_quality_score",
        table_name="source_reputation_profiles",
    )
    op.drop_index(
        "ix_source_reputation_profiles_reliability_score", table_name="source_reputation_profiles"
    )
    ...
    for index_name in [
        "ix_news_sources_is_active",
        "ix_news_sources_tier",
        "ix_news_sources_category",
        "ix_news_sources_slug",
    ]:
    ...
    with op.batch_alter_table("news_articles") as batch_op:
        batch_op.drop_constraint(
            "fk_news_articles_cluster_id_news_article_clusters", type_="foreignkey"
        )
    for index_name in [
    ...
    with op.batch_alter_table("news_articles") as batch_op:
        batch_op.alter_column(
            "metadata_json", existing_type=sa.JSON(), type_=sa.Text(), nullable=False
        )
        for column_name in [
            "is_duplicate",
            "market_impact_score",
