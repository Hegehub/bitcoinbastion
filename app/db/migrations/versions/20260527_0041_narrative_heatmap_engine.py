...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "narrative_id", sa.Integer(), sa.ForeignKey("market_narratives.id"), nullable=False
        ),
    ...
    op.create_index(
        "ix_narrative_snapshots_snapshot_time", "narrative_snapshots", ["snapshot_time"]
    )
    op.create_index("ix_narrative_snapshots_narrative_id", "narrative_snapshots", ["narrative_id"])
    op.create_index(
        "ix_narrative_snapshots_weighted_score", "narrative_snapshots", ["weighted_score"]
    )
    op.create_index(
        "ix_narrative_snapshots_trend_direction", "narrative_snapshots", ["trend_direction"]
    )
