...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("memory_type", sa.String(length=64), nullable=False, server_default="historical_context"),
    ...
    op.create_index("ix_market_memory_records_memory_type", "market_memory_records", ["memory_type"])
    op.create_index("ix_market_memory_records_memory_score", "market_memory_records", ["memory_score"])
    op.create_index("ix_market_memory_records_confidence_score", "market_memory_records", ["confidence_score"])
    ...
    op.create_index("ix_event_fingerprints_event_id", "event_fingerprints", ["event_id"], unique=True)
    op.create_index("ix_event_fingerprints_direction", "event_fingerprints", ["direction"])
    op.create_index("ix_event_fingerprints_confidence_score", "event_fingerprints", ["confidence_score"])
    ...
    op.create_index("ix_pattern_statistics_pattern_id", "pattern_statistics", ["pattern_id"], unique=True)
    ...
    op.create_index("ix_market_memory_operator_reviews_event_id", "market_memory_operator_reviews", ["event_id"])
    op.create_index("ix_market_memory_operator_reviews_pattern_id", "market_memory_operator_reviews", ["pattern_id"])
    op.create_index("ix_market_memory_operator_reviews_similar_event_id", "market_memory_operator_reviews", ["similar_event_id"])
    op.create_index("ix_market_memory_operator_reviews_action", "market_memory_operator_reviews", ["action"])
    op.create_index("ix_market_memory_operator_reviews_false_similarity", "market_memory_operator_reviews", ["false_similarity"])


def downgrade() -> None:
    op.drop_index("ix_market_memory_operator_reviews_false_similarity", table_name="market_memory_operator_reviews")
    op.drop_index("ix_market_memory_operator_reviews_action", table_name="market_memory_operator_reviews")
    op.drop_index("ix_market_memory_operator_reviews_similar_event_id", table_name="market_memory_operator_reviews")
    op.drop_index("ix_market_memory_operator_reviews_pattern_id", table_name="market_memory_operator_reviews")
    op.drop_index("ix_market_memory_operator_reviews_event_id", table_name="market_memory_operator_reviews")
