...
def upgrade() -> None:
    op.add_column(
        "trace_reports",
        sa.Column("privacy_shield_json", sa.Text(), nullable=False, server_default="{}"),
    )
    op.add_column(
        "trace_reports",
        sa.Column("utxo_hygiene_json", sa.Text(), nullable=False, server_default="{}"),
    )
    op.add_column(
        "trace_reports",
        sa.Column("dust_radar_json", sa.Text(), nullable=False, server_default="{}"),
    )
    op.add_column(
        "trace_reports",
        sa.Column("address_reuse_json", sa.Text(), nullable=False, server_default="{}"),
    )
    op.add_column(
        "trace_reports",
        sa.Column("consolidation_risk_json", sa.Text(), nullable=False, server_default="{}"),
    )
    op.add_column(
        "trace_reports",
        sa.Column("toxic_change_json", sa.Text(), nullable=False, server_default="{}"),
    )
