...
def upgrade() -> None:
    ...
    op.add_column(
        "news_sources",
        sa.Column("signal_quality_weight", sa.Float(), nullable=False, server_default="0.7"),
    )
    op.add_column(
        "news_sources",
        sa.Column("sovereignty_weight", sa.Float(), nullable=False, server_default="0.7"),
    )
    op.add_column(
        "news_sources",
        sa.Column("default_confidence", sa.Float(), nullable=False, server_default="0.7"),
    )
    op.add_column(
        "news_sources",
    ...
    op.add_column(
        "news_sources",
        sa.Column("requires_js_rendering", sa.Boolean(), nullable=False, server_default=sa.false()),
    )
    op.add_column(
        "news_sources",
    ...
    op.add_column(
        "news_sources",
        sa.Column("max_failures_before_backoff", sa.Integer(), nullable=False, server_default="3"),
    )
    op.add_column(
        "news_sources", sa.Column("tags_json", sa.JSON(), nullable=False, server_default="[]")
    )
