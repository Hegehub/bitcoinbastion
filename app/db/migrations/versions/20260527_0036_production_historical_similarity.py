...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_market_pattern_library_pattern_code",
        "market_pattern_library",
        ["pattern_code"],
        unique=True,
    )
    op.create_index(
        "ix_market_pattern_library_created_at", "market_pattern_library", ["created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "reference_event_id", sa.Integer(), sa.ForeignKey("news_events.id"), nullable=True
        ),
        sa.Column(
            "reference_article_id", sa.Integer(), sa.ForeignKey("news_articles.id"), nullable=True
        ),
        sa.Column(
            "candidate_event_id", sa.Integer(), sa.ForeignKey("news_events.id"), nullable=True
        ),
        sa.Column(
            "candidate_article_id", sa.Integer(), sa.ForeignKey("news_articles.id"), nullable=True
        ),
    ...
    op.create_index(
        "ix_historical_similarity_records_reference_event_id",
        "historical_similarity_records",
        ["reference_event_id"],
    )
    op.create_index(
        "ix_historical_similarity_records_candidate_event_id",
        "historical_similarity_records",
        ["candidate_event_id"],
    )
    op.create_index(
        "ix_historical_similarity_records_reference_article_id",
        "historical_similarity_records",
        ["reference_article_id"],
    )
    op.create_index(
        "ix_historical_similarity_records_candidate_article_id",
        "historical_similarity_records",
        ["candidate_article_id"],
    )
    op.create_index(
        "ix_historical_similarity_records_similarity_score",
        "historical_similarity_records",
        ["similarity_score"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_historical_similarity_records_similarity_score",
        table_name="historical_similarity_records",
    )
    op.drop_index(
        "ix_historical_similarity_records_candidate_article_id",
        table_name="historical_similarity_records",
