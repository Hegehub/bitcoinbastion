...
| Area | Status | Evidence |
| --- | --- | --- |
| Legacy Next.js frontend removed | implemented | `reflex_frontend/` is the sole repository-native frontend; the decision record is archived at `docs/archive/audits/2026/OLD_FRONTEND_REMOVAL_REPORT.md`. |
