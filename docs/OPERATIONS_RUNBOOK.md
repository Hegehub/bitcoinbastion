...
## RC audit linkage
- Before promotion, attach the current `docs/STATUS.md`, the environment decision required by `docs/PRODUCTION_READINESS.md`, and release evidence output from `python scripts/collect_release_evidence.py`.
