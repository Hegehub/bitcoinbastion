...
PUBLIC_STATUS_ENDPOINT = "/api/v1/public/status"
PUBLIC_FEATURES_ENDPOINT = "/api/v1/public/features"
HEALTH_ENDPOINT = "/api/v1/health"
OBSERVABILITY_ENDPOINT = "/api/v1/observability"


class SovereignGridApiClient:
    ...
    async def get_public_status(self) -> ApiResult:
        return await self._safe_get(PUBLIC_STATUS_ENDPOINT)

    async def get_public_features(self) -> ApiResult:
        return await self._safe_get(PUBLIC_FEATURES_ENDPOINT)

    async def get_health(self) -> ApiResult:
        return await self._safe_get(HEALTH_ENDPOINT)

    async def get_observability(self) -> ApiResult:
