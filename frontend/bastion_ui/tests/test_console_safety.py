...
CONSOLE_PATHS = (
    ROOT / "frontend/bastion_ui/components/console",
    ROOT / "frontend/bastion_ui/routes/console.py",
    ROOT / "frontend/bastion_ui/routes/console_trace.py",
    ROOT / "frontend/bastion_ui/routes/console_evidence.py",
    ROOT / "frontend/bastion_ui/routes/console_provider_health.py",
    ROOT / "frontend/bastion_ui/routes/console_policy.py",
    ROOT / "frontend/bastion_ui/routes/console_audit.py",
)
FORBIDDEN_PARTS = (
    ("clean", "address"),
    ("dirty", "address"),
