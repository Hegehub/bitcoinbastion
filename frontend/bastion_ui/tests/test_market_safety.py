...
MARKET_PATHS = (
    ROOT / "frontend/bastion_ui/components/market",
    ROOT / "frontend/bastion_ui/routes/market_time_machine.py",
    ROOT / "frontend/bastion_ui/routes/market_timeline.py",
    ROOT / "frontend/bastion_ui/routes/market_signals.py",
    ROOT / "frontend/bastion_ui/routes/market_evidence.py",
    ROOT / "frontend/bastion_ui/routes/market_narratives.py",
    ROOT / "frontend/bastion_ui/routes/market_sources.py",
    ROOT / "frontend/bastion_ui/security/market_safety_copy.py",
)
FORBIDDEN_PARTS = (
    ("guaranteed", "profit"),
    ("guaranteed", "signal"),
