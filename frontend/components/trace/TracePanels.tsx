...
export const TraceSafetyPanel = () => <div><h3>Safety Warnings</h3><ul><li>Never enter seed phrases, private keys or wallet files.</li><li>Analysis is advisory-only.</li><li>Results are not legal verification or Bitcoin consensus proof.</li></ul></div>
