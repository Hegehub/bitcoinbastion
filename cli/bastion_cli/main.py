...
def main(
    ctx: typer.Context,
    api_base_url: str | None = typer.Option(None, "--api-base-url", help="Bitcoin Bastion API base URL."),
    token: str | None = typer.Option(None, "--token", help="Bearer token. Never printed."),
    ...
    debug: bool = typer.Option(False, "--debug", help="Show debug diagnostics without printing secrets."),
) -> None:
    ctx.obj = {
