...
def test_near_duplicate_detection() -> None:
    sim = calculate_similarity(
        {"title": "Bitcoin ETF approval today", "canonical_url_hash": "", "content_hash": "a"},
        {
            "title": "Today: bitcoin etf gets approval",
            "canonical_url_hash": "",
            "content_hash": "b",
        },
    )
...
def test_exact_url_duplicate_and_cluster() -> None:
    ...
    a1 = NewsArticle(
        ...
        normalized_title="a",
        url="https://a.com/x",
        raw_url="https://a.com/x",
        canonical_url="https://a.com/x",
        url_hash="",
        canonical_url_hash="",
        title_hash=hash_title("A"),
    ...
    a2 = NewsArticle(
        ...
        raw_url="https://a.com/x?utm_source=z",
        canonical_url="https://a.com/x?utm_source=z",
        url_hash="",
        canonical_url_hash="",
        title_hash=hash_title("A2"),
        normalized_title_hash="",
        content_hash="",
        author="",
        language="en",
