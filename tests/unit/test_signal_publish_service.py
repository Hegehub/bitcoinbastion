...
def test_publish_service_marks_unpublished_signals_as_published(monkeypatch: pytest.MonkeyPatch) -> None:
    _configure_settings()
...
def test_publish_service_suppresses_duplicates_for_same_destination(monkeypatch: pytest.MonkeyPatch) -> None:
    _configure_settings()
    events: list[dict[str, str]] = []
    monkeypatch.setattr(
        "app.services.delivery.publish_service.increment_delivery_publish_event",
...
def test_publish_service_records_failure_and_keeps_signal_unpublished(monkeypatch: pytest.MonkeyPatch) -> None:
    _configure_settings()
    events: list[dict[str, str]] = []
    monkeypatch.setattr(
        "app.services.delivery.publish_service.increment_delivery_publish_event",
...
def test_publish_service_returns_zero_when_destination_not_configured(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_publish_service_returns_zero_when_bot_token_not_configured(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_publish_service_records_unexpected_exception_as_failed(monkeypatch: pytest.MonkeyPatch) -> None:
    _configure_settings()
    events: list[dict[str, str]] = []
    monkeypatch.setattr(
        "app.services.delivery.publish_service.increment_delivery_publish_event",
...
def test_publish_service_continues_after_unexpected_exception(monkeypatch: pytest.MonkeyPatch) -> None:
    _configure_settings()
    events: list[dict[str, str]] = []
    monkeypatch.setattr(
        "app.services.delivery.publish_service.increment_delivery_publish_event",
