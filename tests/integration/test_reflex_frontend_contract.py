...
def test_reflex_core_config_and_routes() -> None:
    ...
    for route in [
        "/check", "/trace", "/trace/[report_id]", "/trace/[report_id]/proof-packet", "/console",
        "/console/trace", "/console/evidence", "/console/market-intelligence", "/console/time-machine",
...
def test_reflex_navigation_uses_current_public_paths() -> None:
    nav = (ROOT / "reflex_frontend/bastion_ui/components/layout/command_palette.py").read_text(encoding="utf-8")
